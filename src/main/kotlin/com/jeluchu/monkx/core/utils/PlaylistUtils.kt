...
class PlaylistUtils(private val headers: Headers = commonEmptyHeaders) {
    ...
    fun extractFromHls(
        ...
        val masterPlaylist = Jsoup.connect(playlistUrl)
            .headers(masterHeaders.toMap())
    ...
    fun extractFromDash(
        ...
        val doc = Jsoup.connect(mpdUrl)
            .headers(mpdHeaders.toMap())
            .ignoreContentType(true)
            .get()
